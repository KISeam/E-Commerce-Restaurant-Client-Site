...
const AddItems = () => {
  ...
  return (
    <>
      <div className="bg-gradient-to-br from-orange-50 to-orange-100 min-h-screen py-20 rounded-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <select
                  ...
                  } rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent focus:outline-none cursor-pointer ${
